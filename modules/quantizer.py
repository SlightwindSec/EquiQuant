...
class ModelslimQuantizer:
    ...
    封装 Modelslim 量化工具。
    """
    def __init__(self, quant_config, base_model_path, fallback_layers, output_config_path, output_weights_path):
        """
        Args:
    ...
    def _generate_quant_config(self):
        ...
        try:
            ...
            # 1. 插入动态的回退层列表
            config_data['spec']['calib_cfg']['disable_names'] = self.fallback_layers
