...
def setup_logger(name="EquiQuant", log_file=None, console_level=logging.INFO, file_level=logging.DEBUG):
    """
    配置一个日志记录器 (Logger)。
    ...
    logger.setLevel(logging.DEBUG)  # 设置 logger 的最低级别为 DEBUG，由 handlers 控制具体输出级别
